...
4. **new binding**:
   ...
   Here is a cheatsheet that can help you find the value of **this** in JavaScript and remember if you're dealing with an arrow function then find the binding of the enclosing function and that's your answer.
