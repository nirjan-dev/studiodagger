...
# Useful tips while learning to code
...
## 2. Don't make random stuff or demo apps from tutorials
...
## 3. Don't try to build complicated stuff too fast
...
- Don't use the DRY principle for everything and use abstractions too early
